...
export default function ForgotPassword() {
    ...
    const [step, setStep] = useState(1);  // Adımları takip eden state
    ...
    const [realCode, setRealCode] = useState("123456");  // Gerçek kod (Mock, API'den gelmeli)
                    ...
                    <div className="forgot-password-box">
                        ...
                        {step === 1 && (
                            <div>
                                ...
                                />
                                <button className="form-btn-primary" onClick={handleEmailSubmit}>Sıfırlama bağlantısı/kodu? gönder </button>
                            </div>
                        )}
                        ...
                        {step === 2 && (
                            <div className="forgot-step2">
                                <h3>KODU GİR</h3>
                                <p>Mail adresinize gelen 6 haneli şifre sıfırlama <br/>kodunu giriniz</p>
                        ...
                        {step === 3 && (
                            <div className="forgot-step3">
                                ...
                                <input 
                                    type="password" 
                                    className="transparent-input mb-5" 
